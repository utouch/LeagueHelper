...
public class CircleProgressView extends View {
    ...
    private void parseAttributes(TypedArray a) {
        barWidth = (int) a.getDimension(R.styleable.CircleProgressView_barWidth,
                barWidth);

        rimWidth = (int) a.getDimension(R.styleable.CircleProgressView_rimWidth,
                rimWidth);

        spinSpeed = (int) a.getDimension(R.styleable.CircleProgressView_spinSpeed,
                spinSpeed);

        delayMillis = a.getInteger(R.styleable.CircleProgressView_delayMillis,
                delayMillis);
        if (delayMillis < 0) {
            delayMillis = 0;
        }

        barColor = a.getColor(R.styleable.CircleProgressView_barColor, barColor);

        barLength = (int) a.getDimension(R.styleable.CircleProgressView_barLength,
                barLength);

        textSize = (int) a.getDimension(R.styleable.CircleProgressView_textSize,
                textSize);

        textColor = (int) a.getColor(R.styleable.CircleProgressView_textColor,
                textColor);
        ...
        rimColor = (int) a.getColor(R.styleable.CircleProgressView_rimColor,
                rimColor);

        circleColor = (int) a.getColor(R.styleable.CircleProgressView_circleColor,
                circleColor);

        contourColor = a.getColor(R.styleable.CircleProgressView_contourColor, contourColor);
        contourSize = a.getDimension(R.styleable.CircleProgressView_contourSize, contourSize);
